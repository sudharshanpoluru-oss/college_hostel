...
export default function WardenNavbar() {
  ...
  useEffect(() => {
    api.get('/warden/notifications').then(r => {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
      <div className="container-fluid px-3">
        <Link className="navbar-brand fw-bold" to="/warden"><i className="bi bi-shield-check me-2"></i>Warden Panel</Link>
          ...
          <div className="dropdown">
            ...
            <div className="dropdown-menu dropdown-menu-end notif-dropdown">
              <div className="dropdown-header d-flex justify-content-between align-items-center">
                ...
                {notifCount > 0 && <Link to="/warden/notifications" className="small text-decoration-none">Mark all read</Link>}
              </div>
              {notifications.length > 0 ? notifications.map(n => (
                <Link className={`dropdown-item notification-item ${n.is_read ? '' : 'unread'}`} to="/warden/notifications" key={n.id}>
              ...
              <div className="dropdown-footer"><Link to="/warden/notifications" className="small text-decoration-none">View all notifications</Link></div>
            </div>
          </div>
          <div className="dropdown">
            ...
            <ul className="dropdown-menu dropdown-menu-end">
              <li><Link className="dropdown-item" to="/warden"><i className="bi bi-person"></i> Profile</Link></li>
