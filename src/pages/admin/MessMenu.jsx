...
export default function MessMenu() {
  const [items, setItems] = useState([]); const [showAdd, setShowAdd] = useState(false); const [editId, setEditId] = useState(null); const [form, setForm] = useState({ day: 'Monday', meal_type: 'Breakfast', menu_items: '' });
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-3"><h4 className="fw-bold mb-0">Mess Menu</h4><button className="btn btn-primary btn-sm" onClick={() => { setForm({ day: 'Monday', meal_type: 'Breakfast', menu_items: '' }); setEditId(null); setShowAdd(true); }}><i className="bi bi-plus"></i> Add</button></div>
